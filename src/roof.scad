...
// Example(3D): Axis FWD and Anchor LEFT
//   include <space.scad>
//   space(l=2,w=2,h=3,debug=true) {
//      roofCut( angle = 20, rot_axis = FWD,rot_anchor = LEFT ) simpleRoof();
//   };
// Example(3D): Axis LEFT and Anchor BACK
//   include <space.scad>
//   space(l=2,w=2,h=3,debug=true) {
...
// Example(3D): Attach to a named anchor
//   include <space.scad>	
//   space(3,2,2.4,200,debug=true) 
