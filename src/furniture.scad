...
// Example(3D,Big,ColorScheme=Nature): King Size bed
//   bed( type = "KingSize" );
// Example(3D,Big,ColorScheme=Nature): Single bed
//   bed( type = "Single" );
// Example(3D,Big,ColorScheme=Nature): Custom size
//   bed( type = "Custom" , width = 800, length = 2100 );
// Example(3D,Big,ColorScheme=Nature): Bed with headboard
...
//
// Example(3D,Big,ColorScheme=Nature): Table for 12 persons
//   squareTable( place = 12 );	
// Example(3D,Big,ColorScheme=Nature): Custom table size 
...
// Example(3D,Big,ColorScheme=Nature): Simple chair
//   stool();
module stool (
    width    = 400, 
    depth    = 400, 
...
// Example(3D,Big,ColorScheme=Nature): Simple 2 rows 3 columns dresser
...
//
// Example(3D,Big,ColorScheme=Nature): Simple
//   desk();
module desk( 
		length    = 1900,    
		height    = 750,
